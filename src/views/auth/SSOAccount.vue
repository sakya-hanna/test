<!-- Figma: 26:927 - COM-AUTH-03 - SSO 账号登录 -->
<template>
    ...
    <div class="flex">
      ...
      <div class="w-[432px] min-h-[627px] rounded-[8px] px-10 py-8 flex flex-col" style="background:rgba(0,0,0,0.5);">
        ...
        <div class="flex gap-0 mb-2">
          ...
          <router-link to="/sso/sms" class="flex-1 text-center text-[20px]" style="color:#ffffff;">短信登录</router-link>
          <router-link to="/sso/account" class="flex-1 text-center text-[20px] font-bold" style="color:#ffffff;">账号登录</router-link>
        </div>
        <hr class="mb-4" style="border-color:rgba(255,255,255,0.3);" />

        <label class="block text-[16px] mb-1.5" style="color:#ffffff;">企业账号</label>
        <input v-model="acc" placeholder="请输入您的账号" class="w-full px-4 py-3 rounded-[8px] border border-white/20 text-[16px] bg-white/10 mb-4 focus:outline-none" style="color:#B3B3B3;" />

        <label class="block text-[16px] mb-1.5" style="color:#ffffff;">密码</label>
        <input v-model="pwd" type="password" placeholder="请输入密码" class="w-full px-4 py-3 rounded-[8px] border border-white/20 text-[16px] bg-white/10 mb-4 focus:outline-none" style="color:#B3B3B3;" />

        <label class="block text-[16px] mb-1.5" style="color:#ffffff;">验证码</label>
        <div class="flex gap-2 mb-6">
          <input v-model="cap" placeholder="请输入验证码" class="w-[159px] px-4 py-3 rounded-[8px] border border-white/20 text-[16px] bg-white/10 focus:outline-none" style="color:#B3B3B3;" />
        ...
        <div class="flex justify-between text-[16px]">
          <span style="color:#ffffff;">忘记密码？请联系学校管理员！</span>
        </div>
      </div>
